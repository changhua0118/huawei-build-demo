...
// 面板的内容
export const template = readFileSync(join(__dirname, '../../../static/platform/huawei/index.html'), 'utf8');

// 面板上的样式
export const style = readFileSync(join(__dirname, '../../../dist/platform/huawei/index.css'), 'utf8');
    ...
    vm = new Vue({
        ...
        methods: {
            ...
            onRun(exePath: string) {
                ...
                exec(`${exePath} -dev`, (error: Error, stdout: any) => {
                    if (error) {
